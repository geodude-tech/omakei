...
The first two were written before the code and are marked _implemented_. The rest
were written after, to capture existing behavior against the intent; they are
marked _documents existing behavior_ and each carries an **Open Questions**
